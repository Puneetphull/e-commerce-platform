...
const trafficShares = [
    { id: 1, label: "Patient", value: 60, color: "secondary", icon: faDesktop },
    { id: 2, label: "Staff", value: 30, color: "primary", icon: faMobileAlt },
    { id: 3, label: "Doctor", value: 10, color: "tertiary", icon: faTabletAlt }
];
