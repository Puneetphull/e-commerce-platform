        ...
        <div class="progress-bar-sign-in">
          ...
          <div class="sign-in-form">
            ...
            <div class="sign-in-link-wrap">
              <a href="#" class="checkout-signin mt-3 d-inline-block">
                Sign In
              </a>
            </div>
            <div class="review-form-wrap checkout-sign-in-form">
              ...
              <form>
                <div class="form-group">
                  <label class="label-txt" for="Email Address">
                    Email Address
                  </label>
                  <input type="email" class="form-control" placeholder="" />
                </div>
                <div class="form-group">
                  <label class="label-txt" for="Password">
                    Password
                  </label>
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <a href="#" class="checkout-forgot-password">
