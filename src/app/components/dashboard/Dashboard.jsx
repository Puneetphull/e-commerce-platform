...
import { CounterWidget, CircleChartWidget, BarChartWidget, TeamMembersWidget, ProgressTrackWidget, RankingWidget, SalesValueWidget, SalesValueWidgetPhone, AcquisitionWidget } from "../../custom-components/Widgets";
import {totalOrders,trafficShares} from '../../data/chartdata';
    ...
    <Dropdown className="btn-toolbar">
      ...
      <Dropdown.Menu className="dashboard-dropdown dropdown-menu-left mt-2">
        ...
        <Dropdown.Item className="fw-bold" onClick={showModal} >
          <FontAwesomeIcon icon={faCloudUploadAlt} className="me-2" /> Book Appointment
        </Dropdown.Item>
        <Dropdown.Item className="fw-bold">
  ...
  <Row>
    <Col xs={12} xl={12} className="mb-4">
      <Row>
        <Col xs={12} xl={8} className="mb-4">
          <Row>
            <Col xs={12} className="mb-4">
              <PageVisitsTable title={"Apointment"} headerCell={patientHeader} data={patientList} />
            </Col>
        ...
        {showAppointment ?  <Appointment show={showAppointment} setShowModal={setAppointment} /> : <></>}
