  ...
  return (
    <div class="view-order" id="divtarget">
      <div class="status-date-block">
        <h3 class="slim-heading">
          Order # {state?.increment_id}{" "}
          <small class="text-muted border text-uppercase px-2">
            {state?.status}
          </small>
        </h3>
        <p class="mb-4"></p>
            ...
            <div class="col-lg-3 mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p>
                    {
                      state?.extension_attributes?.shipping_assignments[0]
            ...
            <div class="col-lg-3 mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p>
                    {state?.billing_address?.street}{" "}
                    {state?.billing_address?.postcode}
                  </p>
                </div>
                {/* <div class="card-footer">
                <ul class="list-inline">
