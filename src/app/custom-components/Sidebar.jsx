...
import {faSignOutAlt, faTimes,  faMoneyCheckDollar, faShoppingCart , faTruckFast, faShoppingBag, faHome, faBagShopping, faList } from "@fortawesome/free-solid-svg-icons";
          ...
          <SimpleBar className={`${props.show ? "contracted" : ""} sidebar d-md-block bg-primary text-white collapse`}>
            <div className="sidebar-inner px-4 pt-3">
              ...
              <Nav className="flex-column pt-3 pt-md-0">
                ...
                <NavItem title="Home" link={customRoutes.adminHome.path} icon={faHome} />
                <NavItem title="Product List" link="/productlisting" icon={faList} />
                ...
                <NavItem title="My Orders" link="/MyOrder" icon={faBagShopping}/>
