...
export function Kanban() {
  return (
    <div>
      <div className="kanban-container py-4 px-0 container-fluid">
        <div className="d-flex flex-nowrap row">
          ...
          >
            ...
            <div className="kanban-list list-group">
              <div
                ...
                draggable="false"
                className="p-4 card border-1"
              >
                <div className="d-flex align-items-center justify-content-between border-0 p-0 mb-3 card-header">
                  <h5 className="mb-0">Redesign homepage</h5>
                  <div>
                    <div className="dropdown">
                      <button
                        ...
                        aria-expanded="false"
                        type="button"
                        className="fs-6 px-1 py-0 dropdown-toggle btn btn-link btn-sm"
                      >
                        <svg
                ...
                <div className="p-0 card-body">
                  ...
                  <div className="avatar-group">
                    <a className="avatar ms-0 card-link" href="#Ryan Tompson">
                      <img
                    ...
                    <a className="avatar ms-0 card-link" href="#Alexander Smith">
                      <img
              ...
              >
                <div className="d-flex align-items-center justify-content-between border-0 p-0 mb-3 card-header">
                  <h5 className="mb-0">Upgrade bootstrap version to latest</h5>
                  <div>
                    <div className="dropdown">
                      <button
          ...
          >
            ...
            <div className="kanban-list list-group">
              ...
              >
                <div className="d-flex align-items-center justify-content-between border-0 p-0 mb-3 card-header">
                  <h5 className="mb-0">Design banner</h5>
                  <div>
                    <div className="dropdown">
                      <button
                ...
                <div className="p-0 card-body">
                  ...
                  <h5 className="fs-6 fw-normal mt-4">2 Assignees</h5>
                  <div className="avatar-group">
                    <a className="avatar ms-0 card-link" href="#Bonnie Green">
                      <img
                    ...
                    <a className="avatar ms-0 card-link" href="#Scott Anderson">
                      <img
          ...
          >
            ...
            <div className="kanban-list list-group">
              ...
              >
                <div className="d-flex align-items-center justify-content-between border-0 p-0 mb-3 card-header">
                  <h5 className="mb-0">variables.scss problems</h5>
                  <div>
                    <div className="dropdown">
                      <button
