  ...
  const TableRow = (props) => {
    ...
    return (
      <tr>
        ...
        <td><FontAwesomeIcon icon={props.icon} role="button" color="green"   /></td>
      </tr>
    );
  };
    ...
    <Card border="light" className="shadow-sm">
      <Card.Header>
        <Row className="align-items-center">
          <Col>
            <h5>{props.title}</h5>
        {props.showDatePicker && props.appointmentType === "2" ?    
        <>
     {/* <DateRangePicker
      ...
      {/* <DateRangePicker
      appearance="default"
      placeholder="Select date for appointement"
      style={{ width: 280 }}
    /> */}
        </>
      ...
      : <></>}
        ...
        {props.seeAll  ?  <Button variant="secondary" size="sm">See all</Button> : <></>}
          </Col>
        </Row>
      </Card.Header>
      <Table responsive className="align-items-center table-flush">
        <thead className="thead-light">
          <tr>
            {props.headerCell ? props.headerCell.map((data,index)=> <th key={index} scope="col">{data.displayName}</th>) : <></>}
